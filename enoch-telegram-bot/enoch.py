...
from modules.enoch_list import enoch_list, handle_add_to_list, delete_from_list, handle_delete
from modules.enoch_reminder import enoch_reminder, delete_from_reminder, handle_delete_reminder, handle_add_to_reminder_start, handle_get_date, handle_get_text, daily_reminder
...
if __name__ == '__main__':
    ...
    enoch_list_handler = CommandHandler('enoch_list', enoch_list)
    enoch_reminder_handler = CommandHandler('enoch_reminder', enoch_reminder)
